...
exports.Swig = function (opts) {
   ...
   * @return {string}             Rendered output.
   */
  this.renderFile = function (pathName, locals, opts, cb) {
    // Let signature function(string, object, function) mean that opts is omitted
    if (!!opts) {
    ...
    if (cb) {
      self.compileFile(pathName, opts, function (err, fn) {
        var result;
    ...
    return self.compileFile(pathName, opts)(locals);
  };
